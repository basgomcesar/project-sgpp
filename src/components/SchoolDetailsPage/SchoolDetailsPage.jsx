    ...
    const AdditionalInfo = () => (
        <div className="card mt-3">
            <div className="card-body">
                ...
                <p><strong>Nombre del Director:</strong> {school?.director_name || "N/A"}</p>
                <p><strong>Sector:</strong> {school?.sector || "N/A"}</p>
                <p><strong>Zona:</strong> {school?.zone || "N/A"}</p>
                <p><strong>Nombre del Jefe de Sector:</strong> {school?.sector_chief_name || "N/A"}</p>
                <p><strong>Nombre del Supervisor de Zona:</strong> {school?.zone_supervisor_name || "N/A"}</p>
                <p><strong>Contexto:</strong> {school?.context || "N/A"}</p>
            </div>
        </div>
    );

    if (loading) return <div className="container mt-4"><p>Cargando detalles...</p></div>;
    if (!school) return <div className="container mt-4"><p>No se encontró la escuela</p></div>;
